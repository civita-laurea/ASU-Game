...
function TasksComponent(props) {
    ...
    const [items, setItems] = useState([
        { title: 'Finish Math Course Grading', checked: false, tag: TAGS.URGENT },
        {
            title: 'Create New Assignment for Physics Course',
            checked: false,
            tag: TAGS.NEW
        },
        { title: 'Online Office Hours of Today', checked: true, tag: TAGS.DEFAULT }
    ]);
