        ...
        >
            ...
            >
                <Row wrap horizontal='space-between'>
                    <Column>
                        <span className={classes.graphTitle}>Monthly Tasks Working Trends</span>
                        <span className={classes.graphSubtitle}>as of Feb 24 2021, 10:21 PM</span>
                    </Column>
                    {renderLegend(theme.color.lightBlue, 'This Month')}
                </Row>
            ...
            <Column flexGrow={3} flexBasis='342px' breakpoints={{ 1024: classes.stats }}>
                {renderStat('Resolved', '204')}
                {renderStat('Received', '210')}
                {renderStat('Average working time', '8h 30m')}
